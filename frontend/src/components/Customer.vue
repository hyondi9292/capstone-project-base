<template>
    ...
    <v-card style="width:300px;" outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="JuminNo" v-model="value.juminNo" :editMode="editMode"/>
            </div>
        </v-card-text>
    ...
    export default {
        ...
        created(){
            ...
            if(typeof this.value === 'object') {
                ...
                if(!('telNo' in this.value)) {
                    this.value.telNo = null;
                }
                if(!('name' in this.value)) {
                    this.value.name = null;
                }
                if(!('juminNo' in this.value)) {
                    this.value.juminNo = null;
                }
            }            
        },
