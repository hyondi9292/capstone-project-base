...
1.외주관리시스템 -- 은행연관? + 은행에 좀 필요할거같아.. 팀별 권한관리.. (++)
...
2.성능
 -보안정책상태 (프론트엔드)에서 확인할 수 있어야 한다 CQRS
...
3.인사정보시스템 -- Dashboard -- 캘린더 / 특히 휴가? 직원일정체크
...
잔액조회를 못하더라도, 로그인이 되어야한다.(365일 24시간 받을 수 있어야 한다(상품처리서비스가 죽더라도,,)
